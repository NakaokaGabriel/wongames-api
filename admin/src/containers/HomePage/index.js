        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>
                ...
                publishers para a nossa maravilha loja de jogos
              </P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>Em caso de duvidas e ou sugestões so ir em um de nossos links.</P>
              <ALink
                rel="noopener noreferrer"
                href="https://react-avancado.com.br"
                target="_blank"
              >
